...
public class TrainingLauncherWindow : EditorWindow
{
    ...
    [MenuItem("Custom/Training Launcher %#t")] // Ctrl+Shift+T
    ...
    private void OnEnable()
    {
        ...
        yamlFilePath = @"C:\Core\SomeBananas\ml-agents\config\ppo\TrafficJam.yaml";
